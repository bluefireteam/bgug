...
class _AnimatedCheckState extends State<_AnimatedCheck> with TickerProviderStateMixin {
  ...
  _AnimatedCheckState() {
    ...
    _curve = CurvedAnimation(parent: _controller, curve: Curves.easeOut)..addListener(_animate);
    _controller.forward();
  }
  ...
  @override
  void dispose() {
    _curve.removeListener(_animate);
    _controller.dispose();
    super.dispose();
  }
